...
CREATE TABLE `subscriptions` (
  ...
  `cancel_at_period_end` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'user or Stripe requested cancellation effective at end_date',
...
ALTER TABLE `subscriptions`
  ...
  ADD CONSTRAINT `chk_subscriptions_date_order` CHECK (`end_date` > `start_date`);
COMMIT;
