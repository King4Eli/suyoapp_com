...
export function Screen_editpreference({ navigation }: { navigation: any }) {
  ...
  }, [navigation, savePreferences, colors.accent, colors.background]);
      ...
      >
        <View style={localStyles.tabWrap}>
          <Pressable
            style={[
              localStyles.tabBtn,
              activeTab === 'basics' && localStyles.tabBtnActive,
            ]}
          ...
          >
            <Text
              style={[
                localStyles.tabText,
                activeTab === 'basics' && localStyles.tabTextActive,
              ]}
            >
              Basics
            </Text>
          ...
          <Pressable
            style={[
              localStyles.tabBtn,
              activeTab === 'more' && localStyles.tabBtnActive,
            ]}
          ...
          >
            <Text
              style={[
                localStyles.tabText,
                activeTab === 'more' && localStyles.tabTextActive,
              ]}
            >
              More
            </Text>
        ...
        {activeTab === 'basics' ? (
          <View style={{ gap: 12 }}>
            ...
            {renderRadioAccordion(
              ...
              id => setPreferences(prev => ({ ...prev, relationshipGoal: id })),
            )}
          </View>
        ) : (
          <View style={{ gap: 12 }}>
            ...
            <View
              ...
              style={!hasPremium ? localStyles.moreDisabledBlock : undefined}
            >
              {renderRadioAccordion(
