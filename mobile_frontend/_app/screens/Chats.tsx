...
export function Screen_chat({ navigation }: { navigation: any }) {
      ...
      >
        ...
        >
          <View style={{ flex: 1, marginRight: 12 }}>
            ...
            >
              {getProfile?.profile?.fullname || 'You'}
            </Text>
            {countNewMatches > 0 && (
              <Text style={{ color: '#cbd5e1', marginTop: 4, fontSize: 13 }}>
                You have {countNewMatches} new connection
                {countNewMatches > 1 ? 's' : ''}. Message them before the sparks
                fade.
              </Text>
            )}
          </View>
  ...
  }, [activeSubscription, countNewMatches, getProfile, navigation]);
