 ...
 */
export const SafeImage = ({ source, style, containerStyle, onError, fallbackIconSize, resizeMode, ...rest }: SafeImageProps) => {
    ...
    if (hasError || !uri) {
        return (
            <View style={[style, containerStyle, { backgroundColor: colors.backgroundSecondary, alignItems: 'center', justifyContent: 'center' }]}>
                <IIcon name="person" size={fallbackIconSize ?? 28} color={colors.textTertiary} />
            </View>
        );
    }
